...
const projectData = [
  {
    ...
    desc: "All Oregon Trails lead to Rome? Not really, but the world of text adventures beckoned me to build an application reminiscent of old-school games. Spiel is a fun and completely personalized journey through the world generated by the user's prompt. Here's the nitty-gritty: <ul><li></li></ul>",
    tags: ["OpenAI API", "Pinecone", "FastAPI", "Next.js"],
    link: "#"
  },
  {
    title: "pAInt",
  ...
  },
  {
    ...
    desc: "A few-shot voice cloning web app built for content creators, podcasters, and accessibility tooling. Upload 30 seconds of audio and generate unlimited speech in that voice. Optimized inference pipeline reduced latency by 60%.",
    tags: ["Tortoise TTS", "Python", "FastAPI", "React"],
    link: "#"
  }
];
